...
class appbarcontentHR extends StatefulWidget {
  final BuildContext context;
  final User user;
  const appbarcontentHR(
      {Key? key,
  ...
  @override
  _appbarcontentHRState createState() => _appbarcontentHRState();
}

class _appbarcontentHRState extends State<appbarcontentHR> {
